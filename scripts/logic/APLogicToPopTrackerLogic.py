...
def process_room_region(logic, room_display_name, region):
...
def add_checkpoint(logic, room_display_name, room):
...
def process_room(logic, level, room):
    ...
    for region in room['regions']:
        process_room_region(logic, room_display_name, region)
    add_checkpoint(logic, room_display_name, room)
